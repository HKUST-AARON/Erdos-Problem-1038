...
This folder contains the five-atom one-variable certificate used in a conditional lower-bound argument for Erdős Problem 1038.
...
note/five_atom_1806304_certificate.md
lean-toolchain
lakefile.toml
lake-manifest.json
```
...
```bash
cd finite_atoms/five_atom_1806304
lake exe cache get
