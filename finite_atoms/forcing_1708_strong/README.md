...
```text
forcing_1708_strong_interval_certificate.json
```
...
```bash
python3 finite_atoms/forcing_1708_strong/scripts/verify_forcing_1708_strong_interval.py \
  --check-json finite_atoms/forcing_1708_strong/forcing_1708_strong_interval_certificate.json
```
...
```text
lean/box_arith_chunks/Forcing1708StrongBoxArith000.lean
...
lean/box_arith_chunks/Forcing1708StrongBoxArith119.lean
lean/Forcing1708StrongBoxData.lean
lean/Forcing1708StrongAggregate.lean
```
...
LEAN_JOBS=8 MATHLIB_WORKSPACE=/path/to/mathlib \
  finite_atoms/forcing_1708_strong/scripts/check_box_arith.sh
```

`lean/Forcing1708StrongAggregate.lean` is the single Lean entry point for the
currently formalized forcing layers.
