...
/-!
# Route closure for the `M = 1.807100` finite-atom update
...
theorem tail_value : Tail = q 99100 1000000 := by
  norm_num [Tail, M, T, q]
...
/-- Conditional closure theorem for the finite-atom route at `M = 1.807100`. -/
...
theorem route_arithmetic_certificate :
    Tail = q 99100 1000000 ∧ T + Tail = M ∧ M < q 1836 1000 := by
  exact ⟨tail_value, final_sum, target_below_forcing_threshold⟩

end

end Route1807100Closure
end Erdos1038
