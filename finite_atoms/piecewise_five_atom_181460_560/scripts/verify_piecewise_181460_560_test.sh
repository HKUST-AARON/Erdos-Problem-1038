...
CERT_JSON="data/piecewise_five_atom_181460_560blocks_margin_tuned_candidate.json"
OUT="certificates/piecewise_five_atom_181460_560blocks_required_domain_certificate.json"

python3 scripts/verify_piecewise_tail_correct_domain.py "$CERT_JSON" --gap-scan
